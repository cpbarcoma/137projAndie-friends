...
public class BattleCity extends Frame implements ActionListener {
	...
	//------------------------------------------BAse CAMP wall ---------------------------	
		...
		for (int i = 0; i < 32; i++) {
			if (i < 16) {
				otherWall.add(new NormalBrick(220 + 21 * i, 300, this)); 
		...
		this.setTitle("CMSC 22 Project - Battle City");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("NewGame")) {
			...
			printable = false;
			JOptionPane.showMessageDialog(null, "PLAYER 1: WASD to move and F to fire \nPLAYER 2: Direction Keys to move and slash to fire",
